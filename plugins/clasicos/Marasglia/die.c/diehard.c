...
/*****************************************************************************/
/* MAC - ajuste para poder ejecutar tests individualmente por línea de       */
/* comandos (para invocación desde el framework).                            */
/*****************************************************************************/
int
main(int argc, char **argv)
{
  ...
  // nro. de test en primer argumento, nombre de archivo en segundo
  else if (argc == 3) {
    int nro = atoi(argv[1]);
    char *fn = argv[2];
    switch(nro) {
